 ...
 * book test example is that the digits of 932 should multiply to 54
 note that this is not the string index method
 */
...
public class mult_digint {
	...
	public static void main(String[] args) {
		...
		hun = integer/100;
		ten= (integer/10); //returns 93
		upten= ten%10; // returns 3
...
//originally done in eclipse, commented lines were used to test what was being returned